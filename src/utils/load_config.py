...
class LoadConfig:
    ...
    def __init__(self) -> None:
        ...
        self.memory_persistence_strategy = app_config["memory"]["memory_persistence_strategy"]

        # Load OpenAI credentials
        self.load_openai_cfg()
        
        # Initialize OpenAI Embeddings with the correct engine
        self.embedding_model = OpenAIEmbeddings(model=self.embedding_model_engine)
